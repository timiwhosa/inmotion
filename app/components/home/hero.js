...
const HomeHero = () => {
  return (
    <header className="px-24 pt-6 gap-10 h-auto w-full flex flex-row items-end  justify-between">
      <div className="left flex w-1/2 max-w-[440px] flex-col gap-3">
        <h1 className="font-['helveticaNeue'] text-[58px] font-black  leading-[1.2]">
          SOLUTIONS <span className="font-['squarepeg'] font-normal">fOR</span>{" "}
          <br />
          <span className="font-normal">TODAY</span> AND <br /> TOMORROW
        </h1>
        <p className="font-normal md:w-[90%] text-base">
